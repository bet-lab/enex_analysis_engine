...
We welcome contributions! Whether you're fixing bugs, adding features, or improving documentation, your help makes this library better for everyone.

- **Report issues**: Found a bug? Have a feature request? Open an issue!
- **Submit pull requests**: Improvements, new components, or documentation updates
- **Share examples**: Have an interesting use case? We'd love to see it!

---

## References

This library is built on solid theoretical foundations:

- **Shukuya, M. (2013)**. *Exergy theory and applications in the built environment*. Springer.
- **Ground-source heat pump COP**: [Research paper](https://www.sciencedirect.com/science/article/pii/S0360544219304347)
- **Air-source heat pump COP**: [IBPSA paper](https://publications.ibpsa.org/proceedings/bs/2023/papers/bs2023_1118.pdf)
...
**Project Maintainer**: Habin Jo  
**Email**: habinjo0608@gmail.com

---

## Acknowledgments

This library is developed for educational, research, and prototyping purposes. It aims to make energy-exergy analysis accessible to researchers, engineers, and students working on building energy systems and energy conversion technologies.
