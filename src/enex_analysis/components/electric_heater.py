...
class ElectricHeater:
    ...
    def system_update(self):
        ...
        while True:
            ...
            self.X_conv = (1 - self.T0 / ((self.T_hs + self.T0) / 2)) * (
                self.Q_conv
            )  # 임시 변경 사항있으니 주의 필요 -----------------------------
            ############################
        ...
        self.energy_balance["heater body"] = {
            ...
            "out": {"Q_st": self.Q_st, "Q_cond": self.Q_cond},
        }
        ...
        self.energy_balance["heater surface"] = {
            ...
            "out": {"Q_conv": self.Q_conv, "Q_rad_hs": self.Q_rad_hs},
        }
        ...
        self.entropy_balance["heater body"] = {
            ...
            "out": {"S_st": self.S_st, "S_cond": self.S_cond},
        }
        ...
        self.entropy_balance["heater surface"] = {
            ...
            "out": {"S_conv": self.S_conv, "S_rad_hs": self.S_rad_hs},
        }
        ...
        self.exergy_balance["heater body"] = {
            ...
            "out": {"X_st": self.X_st, "X_cond": self.X_cond},
        }
        ...
        self.exergy_balance["heater surface"] = {
            ...
            "out": {"X_conv": self.X_conv, "X_rad_hs": self.X_rad_hs},
        }
