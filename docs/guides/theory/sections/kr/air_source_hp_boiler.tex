...
본 절은 \texttt{AirSourceHeatPumpBoiler.py}에 구현된 동적 ASHPB 모델을 기술한다. 증기압축 냉매 사이클, 물리 기반 열교환기, SLSQP 최적화기, 히스테리시스 제어 저탕조를 통합한다.
...
\end{align}
여기서 $\Delta T_\text{ref,evap}$, $\Delta T_\text{ref,cond}$는 SLSQP 최적화 변수이다.
